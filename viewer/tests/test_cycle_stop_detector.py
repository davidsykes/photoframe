...
class CycleStopDetectorTests(unittest.TestCase):
    ...
    def test_stop_if_1_wants_to(self):
        self.reason1.poll.return_value = True
    ...
    def test_stop_if_2_wants_to(self):
        self.reason2.poll.return_value = True
    ...
    def test_stop_if_3_wants_to(self):
        self.reason3.poll.return_value = True
    ...
    def setUp(self):
        self.reason1 = Mock()
        self.reason1.poll.return_value = False
        self.reason2 = Mock()
        self.reason2.poll.return_value = False
        self.reason3 = Mock()
        self.reason3.poll.return_value = False
