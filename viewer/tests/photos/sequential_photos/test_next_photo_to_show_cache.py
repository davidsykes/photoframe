...
class NextPhotoToShowCacheTests(unittest.TestCase):
    def test_the_action_timer_results_are_cachec(self):
        self.next_photo_to_show_timer.run_if_due.return_value = 'next photo'
    ...
    def test_choose_next_photo_caches_the_last_timer_result(self):
        self.next_photo_to_show_timer.run_if_due.side_effect = [
    ...
    def setUp(self):
        self.next_photo_to_show_timer = Mock(spec=ActionTimer)
        self.photo_history = Mock(spec=PhotoHistory)
        self.out = NextPhotoToShowCache(
            self.next_photo_to_show_timer,
            self.photo_history)
